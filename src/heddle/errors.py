...
def unknown_name(code: str, missing: str, known: list[str], contract: str | None = None) -> HeddleError:
    ...
    return HeddleError(code, f"'{missing}' not found{hint}", contract=contract)
